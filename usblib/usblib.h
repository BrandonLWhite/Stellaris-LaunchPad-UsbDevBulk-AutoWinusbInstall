...
typedef struct
{
    ...
    //
    //! This callback is made whenever the USB host requests a string
    //! descriptor from the device that is not in the string descriptor table.
    //
    tStdRequest pfnGetStringDescriptor;
}
tCustomHandlers;
